create table if not exists gira_user(
	id 					bigint,
	...
	fullname 			varchar(2550) not null,
...
alter table gira_group_role_user
add constraint fk_user_group_user foreign key (group_role_id) references gira_group_role (id);